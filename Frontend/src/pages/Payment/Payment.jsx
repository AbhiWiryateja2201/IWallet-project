          ...
          <div className="grid lg:grid-cols-12 gap-6 items-start">
            <div className="lg:col-span-8 bg-surface p-5 md:p-6 rounded-3xl premium-shadow flex flex-col gap-4">
              <div className="relative overflow-hidden aspect-video rounded-2xl bg-black/90 flex items-center justify-center">
                ...
                <div className="animate-scan w-full h-0.5 bg-primary absolute top-0 left-0 z-10" />
                
                <div className="relative z-10 border-2 border-primary/60 w-36 h-36 sm:w-44 sm:h-44 md:w-48 md:h-48 rounded-2xl flex items-center justify-center">
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-4 z-10">
                  ...
                  <button type="button" className="bg-primary hover:bg-primary/90 active:scale-95 text-on-primary p-3 rounded-full shadow-lg transition-all" aria-label="Ambil foto">
            ...
            <div className="lg:col-span-4 flex flex-col gap-4 lg:sticky lg:top-24">
              <button type="button" className="bg-surface p-6 rounded-3xl premium-shadow text-left hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200 group border border-outline-variant/20">
