...
const TopNavBar = () => {
  ...
  return (
  <header className="w-full h-16 sticky top-0 bg-surface/80 dark:bg-surface-container/80 backdrop-blur-md shadow-sm flex justify-end items-center px-4 md:px-6 z-40">
    <div className="flex items-center gap-2 sm:gap-4">
      ...
      <div className="flex items-center gap-2 sm:gap-3 pl-2 sm:pl-4 border-l border-outline-variant/30">
        ...
        <img className="w-8 h-8 sm:w-10 sm:h-10 rounded-full object-cover border-2 border-primary-container" alt={`Professional portrait of ${userName}`} src={avatar} />
      </div>
    </div>
  </header>
  );
