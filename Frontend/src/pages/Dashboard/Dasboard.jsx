...
const BalanceCard = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-primary to-primary-container rounded-[24px] p-8 text-on-primary shadow-lg group lg:col-span-3">
      ...
      <div className="relative z-10">
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <div className="flex items-center gap-3">
              <h3 className="font-display-lg text-[40px] leading-none font-black">
...
const TransactionsList = () => {
  ...
  return (
    <div className="lg:col-span-2 bg-surface rounded-[24px] p-8 premium-shadow">
      <div className="flex justify-between items-center mb-8">
        <h4 className="font-headline-md text-headline-md">Ringkasan Aktivitas</h4>
        <a className="text-primary font-bold text-sm hover:underline" href="#">Lihat Semua</a>
      </div>
...
const MonthlySpending = () => (
  <div className="bg-surface rounded-[24px] p-6 premium-shadow">
...
const IWalletDashboard = () => (
  <div className="p-block-padding flex flex-col gap-stack-gap max-w-7xl mx-auto w-full">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-stack-gap mt-4">
      <TransactionsList />
